import { TOKEN_SECRET } from "../config.js"; //importamos la clave secreta que hemos definido en el archivo config.js
import jwt from "jsonwebtoken"; //importamos el modulo jsonwebtoken
